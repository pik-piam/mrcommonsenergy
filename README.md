...
R package **mrcommonsenergy**, version **0.5.1**
...
Benke F, Hasse R, Krogmann S, Rodrigues R, Schreyer F (2026). "mrcommonsenergy: Preprocessing functions for REMIND and other energy models (no landuse data)." Version: 0.5.1, <https://github.com/pik-piam/mrcommonsenergy>.
