...
R package **mrcommonsenergy**, version **0.4.0**
...
Benke F (2026). "mrcommonsenergy: Preprocessing functions for REMIND and other energy models (no landuse data)." Version: 0.4.0, <https://github.com/pik-piam/mrcommonsenergy>.
